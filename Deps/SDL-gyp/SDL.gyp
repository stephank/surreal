	...
	"targets": [
		{
			...
			"sources": [
				...
				"<(sdl_dir)/src/audio/pulseaudio/SDL_pulseaudio.c",
				"<(sdl_dir)/src/audio/alsa/SDL_alsa_audio.c",
				...
				"<(sdl_dir)/src/joystick/dummy/SDL_sysjoystick.c",
				"<(sdl_dir)/src/loadso/dlopen/SDL_sysloadso.c",
				"<(sdl_dir)/src/loadso/dummy/SDL_sysloadso.c",
				"<(sdl_dir)/src/power/SDL_power.c",
				"<(sdl_dir)/src/power/linux/SDL_syspower.c",
				...
				"<(sdl_dir)/src/timer/dummy/SDL_systimer.c",
